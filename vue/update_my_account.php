...
<section class="container section-login-signup">
    ...
    <div class="col-lg-5 col-md-5 col-xs-12 col-sm-12 form-connection">
        <?php
            $user = updateMyAccountController($_SESSION['login']['id']) ;
        ?>
        <form action="../routeur/index.php" method="POST" id="form-registration" >
            ...
            <div class="form-group">
                ...
                <input id="firts-name" type="text" name="first-name" class="form-control" value=<?php echo "\"",$user["first_name"],"\"" ?>  >
            </div>
            <div class="form-group">
                <label for="date_birth">Date de naissance  : </label>
                <input id="date_birth" name="date_birth" type="date" class="form-control" value=<?php echo $user['date_birth'] ?> >
            </div>
            <div class="form-group">
                <label for="Pseudo">Pseudo : </label>
                <input id="pseudo" name="pseudo" type="text" class="form-control" value=<?php echo $user['pseudo'] ?> >
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input id="phone" name="phone" type="tel" class="form-control" value=<?php echo $user['phone'] ?> >
            </div>
            <div class="form-group">
            ...
            <input class="button-connection" type="submit" value="MODIFER" name="update-myaccount">
